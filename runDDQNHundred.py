...
class ddHierBasicReward(ddMarlDH):
    name = "ddHierBasicReward"
    reward_function = AGENT_REWARD_ENUM.overload


class ddTest(ddMarlDH):
    name = "ddTest"
    num_episodes = 1001
...
assignedAgent =  ddMarlDH #ddqnSingleNoCommunicate #ddqn100MediumHierarchical
...
intelligentOpposition = DdGenericOneHost #ddAdvAntiAimd #DdCoordinatedLowlongDlowSettings #DdCoordinatedMasterSettings #DdRandomMasterSettings
