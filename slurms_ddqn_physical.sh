...
sbatch --dependency=afterok:8353201 output.slurm
...
sed 's/sampleDDQNText/dd_noThrottle/g' output.slurm -i 
sed "s/samplePath/dd_noThrottle/g" output.slurm -i 
sed 's/0 2/0 3/g' output.slurm -i
sbatch --dependency=afterok:8353201 output.slurm


# AIMD
# sed 's/runDDQN/TOADD/g' exp_either.slurm > output.slurm
# sed 's/sampleDDQNText/dd_ddHier/g' output.slurm -i 
# sed "s/samplePath/dd_ddHier/g" output.slurm -i 
# sed 's/0 2/0 1/g' output.slurm -i
# sbatch output.slurm
