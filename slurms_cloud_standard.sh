...
sed "s/samplePath/sTeamDd100SingAdvDdqnGroupHigh/g" output.slurm -i 
sed 's/sampleDDQNText/fbDdGrHigh/g' output.slurm -i 
...
sed "s/samplePath/sTeamDd100SingAdvDdqnGroupLow/g" output.slurm -i 
...
sed "s/samplePath/sTeamDd100SingAdvDdqnSuperHigh/g" output.slurm -i 
