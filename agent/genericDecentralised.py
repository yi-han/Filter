...
class AgentOfAgents(aBase.Agent):
    ...
    def __init__(self, N_action, pre_train_steps, action_per_agent, N_state, sub_agent_list, tau=0.1, discountFactor=0, debug=False, test=False):
        ...
        #assert action_per_agent**self.num_agents==N_action # confirm the numbers add up
    ...
    def update(self, last_state, action, current_state, is_done, reward, next_action=None):
        ...
        actions = Agent.actionToActions(action, self.num_agents, self.action_per_agent)
